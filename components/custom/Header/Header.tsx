...
import { Grid3x3, User, Settings, LogOut, Bell, Menu } from "lucide-react";

// Lazy load the popover components for code splitting
...
const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 h-16 flex items-center justify-between px-6 border-b border-gray-200 bg-white shadow z-10">
        <button
